...
public class SettingDialogController  extends Controller {
    ...
    public void setMainAndInit(MainActivity main) {
     ...
     private void loadPropertyFromFile() {
        ...
        developmentMode = Boolean.parseBoolean(MainActivity.PROPERTIES_MANAGER.getProperty("developmentMode", "false"));
    ...
    private void addPropertyListener() {
        developmentCheckBox.selectedProperty().addListener((observable, oldValue, newValue) -> {
            MainActivity.PROPERTIES_MANAGER.setProperty("developmentMode", newValue ? "true" : "false");
        });
    }
