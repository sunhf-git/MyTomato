...
public class MainActivity extends Application {
    ...
    public MainActivity(TabPane settingDialog) {
        this.settingDialog = settingDialog;
    }
    ...
    private void loadRootLayout() throws IOException {
        FXMLLoader loader = new FXMLLoader();
        System.out.println(MainActivity.class.getResource("view/RootLayout.fxml"));
        loader.setLocation(MainActivity.class.getResource("view/RootLayout.fxml"));
